...
catatan = Label(root, text="QR code akan otomatis tersimpan di Folder Hasil QR Code!", font=('Arial',10,'italic'))
...
def klasifikasi(file_path):
    ...
    if(pred[9]):
        ...
        teks_qr=("Aset inventaris kendaraan adalah Kapal Layar"+'\nPada Tanggal: '+d1+'\nJam: '+Jam)
    ...
    im.paste(region,box)
    im.save('Hasil QR Code/Hasil_QrCode_' + current_time + '.jpg')
